import{_ as L}from"./TheHero.300ad1a9.js";import{_ as M,a as D}from"./BlogPostList.3652da96.js";import{_ as F,o as P,c as T,p as $,f as I,a as f,b as d,w as S,F as N,d as b}from"./entry.83e9feae.js";import{A as R,c as m,p as W,t as y,i as G,r as H,a as Y,m as E}from"./mat4.3b6cdffa.js";import"./query.bb6ba5e8.js";import"./preview.d5be7e48.js";import"./utils.db96769c.js";function V(){var e=new R(3);return R!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0),e}function k(e,t){var a=t[0],r=t[1],i=t[2],n=a*a+r*r+i*i;return n>0&&(n=1/Math.sqrt(n)),e[0]=t[0]*n,e[1]=t[1]*n,e[2]=t[2]*n,e}(function(){var e=V();return function(t,a,r,i,n,l){var o,s;for(a||(a=3),r||(r=0),i?s=Math.min(i*a+r,t.length):s=t.length,o=r;o<s;o+=a)e[0]=t[o],e[1]=t[o+1],e[2]=t[o+2],n(e,e,l),t[o]=e[0],t[o+1]=e[1],t[o+2]=e[2];return t}})();const U={mounted(){const e=document.getElementsByTagName("canvas")[0];e.width=window.innerWidth,e.height=window.innerHeight,this.runWebGL()},methods:{runWebGL(){const e=document.querySelector("canvas"),t=e.getContext("webgl");if(!t)throw new Error("No WebGL for you suckers");function a(C){let A=[];for(let w=0;w<C;w++){const p=()=>Math.random()-.5,u=[p(),p(),p()];k(u,u),A.push(...u)}return A}const r=a(1e5),i=t.createBuffer();t.bindBuffer(t.ARRAY_BUFFER,i),t.bufferData(t.ARRAY_BUFFER,new Float32Array(r),t.STATIC_DRAW);const n=t.createShader(t.VERTEX_SHADER);t.shaderSource(n,`
